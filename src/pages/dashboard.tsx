  ...
  return (
    <PageShell>
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        ...
        <MetricCard detail={`₹${totalBudget.toLocaleString("en-IN")} total`} icon={WalletCards} label="Active budgets" value="3" />
          ...
          {cities.map((city) => (
            <Card className="overflow-hidden" key={city.id}>
              <div className="aspect-[4/3] overflow-hidden bg-muted">
                <img alt={city.name} className="h-full w-full object-cover" src={city.imageUrl} />
              </div>
